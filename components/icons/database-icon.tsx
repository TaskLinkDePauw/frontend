...
export const DatabaseIcon = ({ fill, size, height, width, ...props }: Props) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={width ?? 32} height={height ?? 32} color={"#000000"} fill={"none"}>
